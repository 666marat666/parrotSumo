...
ApplicationWindow {
    ...
    NavigationDrawer {
        ...
        Rectangle {
            ...
            ListView {
                ...
                anchors.fill: parent
                anchors.top: parent.top
                anchors.topMargin: headerMenu.height + dp(20)
    ...
    ListModel {
        ...
        ListElement {fragment: "Control robot"; }
    ...
    WebSocket {
        ...
        onTextMessageReceived: {
            try {
                if (JSON.parse(message)[0] != "mainPictures") {
                    ...
                    if(parsed[0] == "battery")
                        fragment1.setBatteryValue(parsed[1]);
                    else if(parsed[0] == "qr")
                        fragment2.addNotif(parsed[2], parsed[1]);
                }
            }   catch(e) {
                console.log("ERRO : "+e);
            }
